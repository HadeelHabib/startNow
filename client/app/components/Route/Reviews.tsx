...
export const reviews = [
  {
    ...
    profession: "Student | Tishreen university",
    comment:
    "I had the pleasure of exploring 'START NOW', a website that provides an extensive range of courses on various tech-related topics. I was thoroughly impressed with my experience, as the website offers a comprehensive selection of courses that cater to different skill levels and interests. If you're looking to enhance your knowledge and skills in the tech industry, I highly recommend checking out 'START NOW'!",
},
  {
    name: "Nada Ali",
    avatar: "https://randomuser.me/api/portraits/women/1.jpg",
    profession: "Full stack developer | ALbaath university",
    comment:
...
},
  {
    ...
    profession: "computer systems engineering student | Cairo university",
    comment:
    "Thanks for your amazing programming tutorial channel! Your teaching style is outstanding, and the quality of your tutorials is top-notch. Your ability to break down complex topics into manageable parts, and cover diverse programming languages and topics is truly impressive. The practical applications and real-world examples you incorporate reinforce the theoretical knowledge and provide valuable insights. Your engagement with the audience fosters a supportive learning environment. Thank you for your dedication, expertise, and passion for teaching programming, and keep up the fantastic work!"},
  {
    name: "Muna Mohammad",
    avatar: "https://randomuser.me/api/portraits/women/2.jpg",
    profession: "Junior Web Developer | Iraq",
    comment:
    "I had the pleasure of exploring 'START NOW', a website that provides an extensive range of courses on various tech-related topics. I was thoroughly impressed with my experience",
},
  {
    name: "Rose Meray",
    avatar: "https://randomuser.me/api/portraits/women/3.jpg",
    profession: "Full stack web developer | Lebanon",
    comment:
...
},
  {
    ...
    profession: "Full stack web developer | UAE",
    comment:
    "Join 'START NOW'! 'START NOW' focuses on practical applications rather than just teaching the theory behind programming languages or frameworks. I took a lesson on creating a web marketplace using React JS, and it was very helpful in teaching me the different stages involved in creating a project from start to finish. Overall, I highly recommend 'START NOW' to anyone looking to improve their programming skills and build practical projects. 'START NOW' is a great resource that will help you take your skills to the next level.",
},
];
...
const Reviews = (props: Props) => {
  ...
  <div className="w-[90%] 800px:w-[85%] m-auto">
      ...
      <div className="800px:w-[50%] w-full">
        <Image
        src={require("../../../public/assests/avt-6.png")}
        alt="business"
        width={400}
        height={700}
        />
